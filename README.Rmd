...
The geojsonsf package relies on C++ headers from the `rapidjsonr` package so install that first

```{r, eval = F}
install.packages("rapidjsonr")
```

When released on CRAN you install `geojsonsf` in the usual way
