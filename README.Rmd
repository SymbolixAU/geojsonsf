...
To quickly parse between GeoJSON and `sf` objects, and to handle cases not supported by `sf`.
...
And going the other way you can also return a vector of GeoJSON by using `atomise = TRUE`
